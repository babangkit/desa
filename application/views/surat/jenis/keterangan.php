<!-- /.BIO -->
                      ...
                      <tr>
                      <td style="padding: 0 40px; padding-bottom: 3px;"><?=$i++;?>. Tempat Tinggal</td>
                      <td style="padding: 0 10px; padding-bottom: 3px;">:&nbsp; KEDUNGGEDE, RT.<?=$rt;?> / RW.<?=$rw;?></td>
                      </tr>
                      <tr>
                      <td style="padding: 0 40px; padding-bottom: 3px;"><?=$i++;?>. Surat Bukti Diri</td>
                      <td style="padding: 0 10px; padding-bottom: 3px;">:&nbsp; NIK: <?=$user['username'];?></td>
                      </tr>
                      <tr>
                      <td style="padding: 0 40px; padding-bottom: 3px;"></td>
                      <td style="padding: 0 10px; padding-bottom: 3px;">&nbsp;&nbsp; No.KK: <?=$user['username'];?></td>
                      </tr>
                      <tr>
                      <td style="padding: 0 40px; padding-bottom: 3px;"><?=$i++;?>. Keperluan</td>
                      <td style="padding: 0 10px; padding-bottom: 3px;">:&nbsp; </td>
                      </tr>
                      <tr>
                      <td style="padding: 0 40px; padding-bottom: 3px; padding-top: 10px;"><?=$i++;?>. Berlaku</td>
                      <td style="padding: 0 10px; padding-bottom: 3px; padding-top: 10px;">:&nbsp; -</td>
                      </tr>
                      <tr>
                      <td style="padding: 0 40px; padding-bottom: 3px;"><?=$i++;?>. Keterangan Lain</td>
                      <td style="padding: 0 10px; padding-bottom: 3px;">:&nbsp; -</td>
                      </tr>
                      </table>
                      </div>
